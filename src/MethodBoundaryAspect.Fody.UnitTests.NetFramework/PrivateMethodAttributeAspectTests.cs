...
{
    public class PrivateMethodAttributeAspectTests : MethodBoundaryAspectNetFrameworkTestBase
    {
        private static readonly Type TestClassType = typeof(PrivateMethodAttributeAspectMethods);
        ...
        public void IfMethodIsCalled_ThenTheOnMethodBoundaryAspectShouldBeCalled()
        {
            ...
            // Assert
            result.Should().Be("PrivateMethod");
        }
    }
}